...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/ressources/plugins/iCheck/square/blue.css">
...
<div class="register-box">
  <div class="register-logo">
    <a href="index2.html"><b>My</b>WishList</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Création d'un nouveau compte</p>
    ...
    <form action="server.php" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="password2" class="form-control" placeholder="Retapez votre mot de passe">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-6">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Créer un compte</button>
        </div>
          <div class="col-xs-6">
              <a href="login.php" class="text-center pull-right">J'ai déjà un compte</a>
          </div>
        <!-- /.col -->
      </div>
        ...
        if(isset($_GET['error']))
        {
          ...
          else
          {
            if($_GET['error']==1)
            {
              ...
              <div class="alert alert-danger alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <h4><i class="icon fa fa-ban"></i> Utilisateur existant </h4>
              </div>
              <?php
            }
          }
...
<!-- iCheck -->
<script src="/ressources/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
